    ...
    <div id="wrapper">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="block m-t-xs"><strong class="font-bold">${result.staff.loginName}</strong></span>
                                <span class="text-muted text-xs block">${result.staff.realName}<b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="${ctx}/staff/viewModifyPwd" style="display:none" permCheck="auth_admin_sys_individual_modifyPwd,QUERY,hide">修改密码</a>
                                </li>
                                <li><a class="J_menuItem" href="${ctx}/staff/viewModifyInfo" style="display:none" permCheck="auth_admin_sys_individual_modifyInfo,QUERY,hide">修改帐号信息</a>
                                </li>
                                <li class="divider"></li>
                                <li><a href="javascript:;" id="logout">安全退出</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a id="logout2" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
