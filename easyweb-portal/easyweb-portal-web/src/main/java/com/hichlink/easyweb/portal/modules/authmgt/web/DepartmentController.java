...
public class DepartmentController extends BaseController {
	...
	public Map<String, ? extends Object> findDepartmentInfo(Long departmentId) {
		try {
			 ...
			 * 
			 * for(Role r : roles){ roleBuffer.append(r.getRoleName())
			 * .append(","); }
			 */
			 ...
			 * 
			 * for(Staff s : staffs){ staffBuffer.append(s.getLoginName())
			 * .append(","); }
			 */
	...
	public Map<String, ? extends Object> updateStaffRole(@RequestParam String operation,
			@RequestParam Long departmentId, @RequestParam Long roleId) {
	...
	public Map<String, ? extends Object> updateStaffDepartment(@RequestParam Long departmentId,
			@RequestParam String staffIds, @RequestParam String oraginalIds) {
		try {
			...
			LOGGER.error("根据[staffIds]=" + staffIds + ",[oraginalIds]=" + oraginalIds + ",[departmentId]="
					+ departmentId + ",更新部门用户出错", e);
			return fail(e.getMessage());
		}
	}
	...
	// @ResponseBody
	// public Map<String, ? extends Object> listStaffsInDepartment(String
	// departmentId) {
	// try {
	//
	//
