...
//        String resourceIdAndOperationKey = getRequest().getParameter("resourceIdAndOperationKey");
        try {
...
//			e.printStackTrace();
	...
	public Map<String, ? extends Object> updateRoleResource(@RequestParam Long roleId,
		...
		try {
			...
			roleService.updateRoleResource(roleId, 
					createRoleResourceOperationList(resourceIdAndOperationKey));
