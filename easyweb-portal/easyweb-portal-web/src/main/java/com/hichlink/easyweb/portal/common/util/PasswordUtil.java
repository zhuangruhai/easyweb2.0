...
public final class PasswordUtil {
	...
	private static final byte normalChars[] = { 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82,
	...
	public static String cryptPassword(final String key, final String password) {
		...
		try {
			...
			throw new PasswordException("加密算法：" + PasswordUtil.ALGORITHM_PBEWithMD5AndDES + "的私钥" + secretKey + "不正确！",
					e);
		} catch (InvalidAlgorithmParameterException e) {
			throw new PasswordException("加密算法：" + PasswordUtil.ALGORITHM_PBEWithMD5AndDES + "的参数" + parameter + "不正确！",
					e);
	...
	public static boolean verifyPasswordLength(final String password) throws PasswordException {
		...
		// int minLength =
		// SecurityConfig.getConfig().getInt("password.minimum-length");
		// int maxLength =
		// SecurityConfig.getConfig().getInt("password.maximum-length");
		// int minLength =
		// SecurityConfig.getSecurityConfig().getPasswordMinLength();
		// int maxLength =
		// SecurityConfig.getSecurityConfig().getPasswordMaxLength();
	...
	public static boolean verifyPasswordComplex(final String password) throws PasswordException {
		...
		// String rule =
		// SecurityConfig.getConfig().getString("password.complex-rule");
		// String rule =
		// SecurityConfig.getSecurityConfig().getPasswordComplexRule();
